...
interface InAppBrowser {
    ...
    /**
     * Opens a URL in a new InAppBrowser instance, the current browser instance,
     ...
     *        feature's name/value pairs must be separated by a comma.
     *        Feature names are case-insensitive.
     * @param preloadCode
     *        JavaScript code to inject into the InAppBrowser before page load.
     * @param menu
     *        Optional list of URL entries to display as a subtitle menu.
     ...
     */
    open(url: string, target?: string, options?: string, preloadCode?: string, menu?: {key: string, value: string}[]): InAppBrowser;
